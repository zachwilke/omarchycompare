...
export const features: Feature[] = [
  ...
  {
    id: "local-models",
    name: "Local models from Install > AI",
    tease: "LM Studio for the GUI. Ollama for the CLI. Both from the menu.",
    category: "Agent-first OS",
    omarchy:
      "Install > AI recommends two ways to run local models: LM Studio and Ollama. LM Studio is the GUI for finding, installing, and running open-weight models. Ollama is the CLI path. New to local models? Start with LM Studio.",
    macReach: "Install LM Studio or Ollama yourself",
    windowsReach: "Install LM Studio or Ollama yourself",
    columns: {
      omarchy: {
        verdict: "better",
        label: "LM Studio + Ollama",
        note: "A menu entry. First run is the install.",
      },
      macos: {
        verdict: "no",
        label: "Install them yourself",
        note: "The apps exist. The OS does not ship an Install > AI path.",
      },
      windows: {
        verdict: "no",
        label: "Install them yourself",
  ...
  {
    id: "grok-chatgpt",
    name: "Grok Bot and ChatGPT desktop",
    tease: "Same Install > AI menu. Graphical apps, one path.",
    category: "Agent-first OS",
    omarchy:
      "Install > AI also carries the ChatGPT desktop app and Grok Bot for chatting with xAI’s models. Same menu as the local-model installs.",
    macReach: "Chat apps from the store",
    windowsReach: "Chat apps from the store",
    columns: {
      omarchy: {
        verdict: "better",
        label: "Grok Bot + ChatGPT",
        note: "Graphical apps on the same Install > AI menu.",
      },
      macos: {
        verdict: "different",
        label: "The App Store, or a download",
        note: "Chat apps exist. They are not an OS install menu.",
      },
      windows: {
        verdict: "different",
        label: "The Store, or a download",
        note: "Chat apps exist. They are not an OS install menu.",
      },
    },
    source: "AI — The Omarchy Manual",
